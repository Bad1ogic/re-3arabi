 ...
 * Generated: 2026-09-11T16:57:40.505Z
 */
...
var require_extractor = __commonJS({
  "src/lib/extractor.js"(exports2, module2) {
    ...
    module2.exports = { extractFromUrl: extractFromUrl2, extractStreamsFromText, extractSmartPlayer: extractSmartPlayer2, extractDailymotion, extractMailRuPublic, base64Encode, unpackPacked, toStream, cleanStreamUrl, decryptSmartPlayer, parseMasterPlaylist, expandM3u8Qualities, expandFromMasterText, expandArtRkUrlset };
  }
});
...
async function loadLinks(url) {
  const streams = [];
  const iframes = await deepSearchIframes(url, 0, /* @__PURE__ */ new Set());
