 ...
 * Generated: 2026-09-11T16:57:40.386Z
 */
  ...
  "src/lib/extractor.js"(exports2, module2) {
    ...
    async function extractMailRuPublic(url, headers) {
      ...
      try {
        ...
        return expandFromMasterText(toStream2("MailRu", "MailRu", masterUrl, "auto", hdr), text);
      } catch (e) {
        return [];
      }
    }
    ...
    async function extractSmartPlayer2(playerUrl, referer) {
      const streams = [];
    ...
    async function extractStreamsFromText(html, pageUrl, referer, depth, visited) {
      ...
      while ((m = smartRe.exec(html)) !== null) {
        for (const s of await extractSmartPlayer2(m[2], referer)) pushStream(s);
      }
    ...
    module2.exports = { extractFromUrl: extractFromUrl2, extractStreamsFromText, extractSmartPlayer: extractSmartPlayer2, extractDailymotion, extractMailRuPublic, base64Encode, unpackPacked, toStream: toStream2, cleanStreamUrl, decryptSmartPlayer, parseMasterPlaylist, expandM3u8Qualities, expandFromMasterText, expandArtRkUrlset };
  }
});
